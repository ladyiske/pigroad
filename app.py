...
# 🎨 [디자인 커스텀] 메뉴 상자 높이를 -240px -> -340px로 수정하여 더 위로 올림
st.markdown(
    """
    <style>
    /* 전체 웹사이트 배경을 연핑크로 변경 */
    ...
    /* ★ [높이 정밀 수정] margin-top을 -340px로 늘려 메뉴판을 완전히 위로 인양 ★ */
    .mouth-menu-box {
        position: absolute;
        left: 50%;
        margin-left: -320px; /* 돼지 왼쪽 배치 유지 */
        
        top: 0;
        margin-top: -340px; /* ★ 기존 -240px에서 위로 100px 더 끌어올렸습니다! ★ */
