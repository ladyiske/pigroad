...
if st.session_state.clicked and st.session_state.recommended_menu:
    ...
    # 말풍선 출력 부분 (글자 색상을 확실하게 지정)
    st.markdown(f"""
        <div style="background: white; border: 5px solid #FF6B8B; border-radius: 20px; padding: 25px; text-align: center; margin: 0 auto; max-width: 400px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
            <h3 style="color: #FF6B8B !important; margin-bottom: 10px;">오늘의 추천!</h3>
            <p style="font-size: 1.8rem !important; font-weight: 800 !important; color: #2B2B2B !important; margin: 0;">
