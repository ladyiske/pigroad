        ...
        if st.button("주문하기! 🛎️"):
            ...
            if final_file is None:
                ...
                if success_read and menus:
                    # ★ 버튼을 누른 '이 순간'에만 딱 한 번 뽑아서 보관함에 박제합니다!
...
if st.session_state.clicked and st.session_state.recommended_menu:
    ...
    # 이제 사용자가 카테고리를 마구 바꿔도 보관함에 저장된 메뉴만 계속 보여줍니다.
    st.markdown(
        f"""
